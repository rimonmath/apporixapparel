...
// Vite glob import (all dashboard .vue files)
const rootPages = import.meta.glob('../pages/dashboard/**/*.vue')
...
Object.keys(rootPages).forEach((filePath) => {
  const match = filePath.match(/\/dashboard\/(.+)\.vue$/)
